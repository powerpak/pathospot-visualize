...
function redirectShortUrls($mrsa_db = '') {
  $SHORT_URLS = array(
    ...
    'S2B' => 'dendro-timeline.php?db={{}}&assemblies=S_aureus_ER10871_3A_026677%20S_aureus_ER05215_3A_023863%20S_aureus_ER05295_3A_024902&colorNodes=ordered&filter=&timelineGrouping=0&isolateTests=&variantLabels=gene&variantNtOrAa=nt&showOverlaps=1&tolerance=12&sort=()',
    'S3' => 'heatmap.php?db={{}}&filter=mergeSamePt&snps=15&order=groupOrder&range=0%7C0.15&mode=network&play=1'
  );
